...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      ...
      >
        {/* Hero Section */}
        <motion.div id="hero" className="text-center mb-16 pt-10" variants={itemVariants}>
          <Image
        ...
        <motion.div id="certificates" variants={itemVariants}>
        ...
        <motion.div id="personal-photos" className="mb-8 mt-16" variants={itemVariants}>
          <div className="mb-8 flex items-center justify-between">
        ...
        <motion.div id="professional-experience" className="mb-8 mt-16" variants={itemVariants}>
        ...
        {/* Skills Section */}
        <motion.div id="skills" className="mb-8 mt-16" variants={itemVariants}>
        ...
        <motion.div id="education-and-certificates" className="mb-8 mt-16" variants={itemVariants}>
        ...
        <motion.div id="professional-summary" className="mb-8 mt-16" variants={itemVariants}>
        ...
        <motion.div id="latest-work-examples" className="mb-8 mt-16" variants={itemVariants}>
        ...
        {/* Socials Section */}
        <motion.div id="socials" className="mb-8 mt-16" variants={itemVariants}>
        ...
        {/* Languages Section */}
        <motion.div id="languages" className="mb-8 mt-16" variants={itemVariants}>
        ...
        {/* Contact Information */}
        <motion.div id="contact" className="mb-8 mt-16" variants={itemVariants}>
